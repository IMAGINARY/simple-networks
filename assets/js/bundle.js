...
var TutorialLevelA = /*#__PURE__*/function (_Level) {
  ...
  function TutorialLevelA() {
    ...
    _this = _super.call(this, "A simple Network: Double its input!", new _Network.Network(nodes, [nodes[0]], //input nodes
...
var TutorialLevelB = /*#__PURE__*/function (_Level2) {
  ...
  function TutorialLevelB() {
    ...
    var trainYs = trainXs.map(f);
    _this2 = _super2.call(this, "Propagate only positive values!", new _Network.Network(nodes, [nodes[0]], //input nodes
...
var TutorialLevelC = /*#__PURE__*/function (_Level3) {
  ...
  function TutorialLevelC() {
    ...
    var trainXs = [-2, -1, 0, 1, 2, 3];
    var trainYs = trainXs.map(f);
    _this3 = _super3.call(this, "Internal nodes with bias", new _Network.Network(nodes, [nodes[0]], //input nodes
    [nodes[2]] //output nodes
    ), ["input"], trainXs.map(function (x) {
      return [x];
    }), //temperatures are internally divided by 10.
...
var FahrenheitLevel = /*#__PURE__*/function (_Level5) {
  ...
  function FahrenheitLevel() {
    ...
    _this5 = _super5.call(this, "Convert Celsius to Fahrenheit.", new _Network.Network(nodes, [nodes[0]], //input nodes
    [nodes[2]] //output nodes
...
var SumLevel = /*#__PURE__*/function (_Level6) {
  ...
  function SumLevel() {
    ...
    _this6 = _super6.call(this, "The sum of the input activations.", new _Network.Network(nodes, [nodes[0], nodes[1]], //input nodes
    [nodes[2]] //output nodes
...
var AndLevel = /*#__PURE__*/function (_Level7) {
  ...
  function AndLevel() {
    ...
    _this7 = _super7.call(this, "Are both inputs set to 1?", nw, ["bit 1", "bit 2"], trainXs, //temperatures are internally divided by 10.
...
var MaxLevel = /*#__PURE__*/function (_Level8) {
  ...
  function MaxLevel() {
    ...
    _this8 = _super8.call(this, "Compute the maximum of the input activations.", nw, ["input 1", "input 2"], trainXs, //temperatures are internally divided by 10.
...
var XorLevel = /*#__PURE__*/function (_Level9) {
  ...
  function XorLevel() {
    ...
    var trainXs = [[0, 0], [1, 0], [0, 1], [1, 1]];
    var trainYs = [[0], [1], [1], [0]];
    _this9 = _super9.call(this, "Compute the XOR of the input bits.", nw, ["bit 1", "bit 2"], trainXs, //temperatures are internally divided by 10.
...
var AvgLevel = /*#__PURE__*/function (_Level10) {
  ...
  function AvgLevel() {
    ...
    _this10 = _super10.call(this, "The average of the input values.", nw, ["number 1", "number 2", "number 3"], trainXs, //temperatures are internally divided by 10.
